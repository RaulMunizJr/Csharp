...
/* Go to app and right click on references, add -> project -> add custom library.
 * Make sure the app is bold, if not right click app and set as "start-up project"
 * Toolbox: All windows forms for options, more available from 3rd parties..
 * Make sure to rename property value as well: Alphabetical -> School up (name) to avoid confusion.
 */